...
import ReviewService from "../../services/ReviewService"; // Giả sử bạn có ReviewService để gọi API
      ...
      <div className="row">
        <div className="col-md-6 mb-3">
          <Form.Group controlId="formRating">
            <Form.Label>Đánh giá <span className="text-danger">(*)</span></Form.Label>
            <Form.Control
              type="number"
              name="rating"
              min={1}
